...
Relay* RobotMap::towerLightsWht = NULL;
Relay* RobotMap::towerLightsBlu = NULL;
...
void RobotMap::init() {
	...
	towerLightsWht = new Relay(1, 2);
	lw->AddActuator("Tower Lights", "Wht", towerLightsWht);
	
	towerLightsBlu = new Relay(1, 3);
	lw->AddActuator("Tower Lights", "Blu", towerLightsBlu);
	
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

	// initally turn off tower lights
	towerLightsRed->Set(Relay::kOff);
	towerLightsWht->Set(Relay::kOff);
	towerLightsBlu->Set(Relay::kOff);
}
